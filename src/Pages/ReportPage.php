...
use SilverstripeAustralia\AdvancedReports\Services\AdvancedReportsServiceInterface;
 ...
 */
class ReportPage extends SiteTree
{
    ...
    private static $has_one = array(
        'ReportTemplate' => AdvancedReport::class
    );
...
class ReportPageController extends ContentController
{
