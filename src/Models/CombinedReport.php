...
use SilverstripeAustralia\AdvancedReports\Models\RelatedReport;
...
class CombinedReport extends AdvancedReport
{
    ...
    private static $has_many = array(
        'ChildReports'        => RelatedReport::class,
    );
    ...
    public function prepareAndGenerate()
    {
        ...
        if ($toClone) {
            foreach ($toClone as $child) {
                ...
                $clonedChild->Created = DBDatetime::now();
                $clonedChild->LastEdited = DBDatetime::now();
